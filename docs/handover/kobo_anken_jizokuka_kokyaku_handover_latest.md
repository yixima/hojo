...
**2026-09-04 時点で未確認だった2点は解消した（v2）**
- 顧客向け案内は＜一般型 通常枠＞と資料から確定（§2-4）。＜一般型＞第20回の公募要領は取得済み（§4-2b）。
...
| ファイル | 置き場所 | 何のために |
|---|---|---|
| `kobo_anken_jizokuka_kokyaku_handover_latest.md` | Drive `claude_handover/kobo_anken/`＋`docs/handover/` | 本ファイル（固定名。Drive にはこれ1本だけ） |
| `kobo_anken_jizokuka_kokyaku_handover_20260904_v1.md` | `docs/handover/` のみ | 履歴版（Drive には置かない） |
